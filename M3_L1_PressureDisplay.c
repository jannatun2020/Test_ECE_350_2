 ...
 ***************************************************
 *
 * FILE NAME  :  M3_L1_PressureDisplay.c    
 * DESCRIPTION:  This program reads pressure for a 
 *               period of time and writes values in file.
 *
 **************************************************/
...
#define Slave_Addr 0x60  // MLP3115A2 Pressure Sensor address
...
int main()
{
	...
	if (status < 0){
		 ...
		 printf("Check i2cdetect -r -y 2 for 0x60\n");
